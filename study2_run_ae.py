...
for i, ae_version in enumerate(ae_version):
    for idx, dataset in enumerate(datasets):
        ...
        for fold, (train_index, test_index) in enumerate(kf.split(x), start=1):
            folder = 'result/study2/feature/' + dataset
            ...
            ae_train = pd.DataFrame(ae_train)
            ae_test = pd.DataFrame(ae_test)
            ae_train.to_csv(folder + '/2ae+smote_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            ...
            ae_train = pd.DataFrame(ae_train)
            ae_test = pd.DataFrame(ae_test)
            ae_train.to_csv(folder + '/3ae+cluster_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            ...
            ae_train = pd.DataFrame(ae_train)
            ae_test = pd.DataFrame(ae_test)
            ae_train.to_csv(folder + '/4ae+smotenn_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            ...
            # fusion_train.to_csv(folder + '/ae_fusion_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            # fusion_test.to_csv(folder + '/ae_fusion_test_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')

            # # ae>fusion+smote
            # ae_x_train_smote, ae_y_train_smote = data_resample('smote', fusion_train, y_train)
            # ae_x_train_smote = pd.DataFrame(ae_x_train_smote)
            # ae_y_train_smote = pd.DataFrame(ae_y_train_smote)
            # ae_x_train_smote.to_csv(folder + '/ae_fusion+smote_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            # ae_y_train_smote.to_csv(folder + '/ae_fusion+smote_test_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')

            # # ae>fusion+cluster
            # ae_x_train_smote, ae_y_train_smote = data_resample('cluster', fusion_train, y_train)
            # ae_x_train_smote = pd.DataFrame(ae_x_train_smote)
            # ae_y_train_smote = pd.DataFrame(ae_y_train_smote)
            # ae_x_train_smote.to_csv(folder + '/ae_fusion+cluster_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            # ae_y_train_smote.to_csv(folder + '/ae_fusion+cluster_test_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')

            # # ae>fusion+smotenn
            # ae_x_train_smote, ae_y_train_smote = data_resample('smotenn', fusion_train, y_train)
            # ae_x_train_smote = pd.DataFrame(ae_x_train_smote)
            # ae_y_train_smote = pd.DataFrame(ae_y_train_smote)
            # ae_x_train_smote.to_csv(folder + '/ae_fusion+smotenn_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            # ae_y_train_smote.to_csv(folder + '/ae_fusion+smotenn_test_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            ...
            # fusion_train = pd.DataFrame(fusion_train)
            # fusion_test = pd.DataFrame(fusion_test)
            # fusion_train.to_csv(folder + '/smote_ae_fusion_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            # fusion_test.to_csv(folder + '/smote_ae_fusion_test_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            ...
            # fusion_train = pd.DataFrame(fusion_train)
            # fusion_test = pd.DataFrame(fusion_test)
            # fusion_train.to_csv(folder + '/cluster_ae_fusion_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            # fusion_test.to_csv(folder + '/cluster_ae_fusion_test_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            ...
            # fusion_train = pd.DataFrame(fusion_train)
            # fusion_test = pd.DataFrame(fusion_test)
            # fusion_train.to_csv(folder + '/smotenn_ae_fusion_train_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
            # fusion_test.to_csv(folder + '/smotenn_ae_fusion_test_' + ae_version + '_' + str(fold) + '.csv', index=False, encoding='utf-8')
